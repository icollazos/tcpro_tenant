...
$rango = 45;
$sql = "SELECT ultimafecha FROM aaa_item WHERE id = $iditem"; // Usar parámetros para evitar inyección SQL
$stmt = $conn->prepare($sql);
