...
$hoy = date("Y-m-d");
$sql = "SELECT id AS iditem, id_tipoitem_item AS idtipoitem, descriptor AS item, ultimafecha as ultimafecha, borrar as borrar FROM v_aaa_item WHERE v_aaa_item.id>'1' AND (borrar IS NULL OR borrar=0) AND ultimafecha <> '$hoy' ORDER BY v_aaa_item.id ASC LIMIT 1"; //regresar($sql);
...
//sleep(5);
header("Location:http://localhost/tcpro4/apiCustom/cron_newsapi_onclick_2024_12_14_separado.php");
die();
