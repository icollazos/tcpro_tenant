...
function buscaTextos($conn){
    ...
    $clausulaPalabras=EticlausulaPalabras($_GET['palabra'],'v_aaa_textovalor.descriptor_texto_textovalor');
    ...
    $clausulaFechaI=EticlausulaFechaI($_GET['fechaInicial']);
    $clausulaFechaF=EticlausulaFechaF($_GET['fechaFinal']);
    $clausulaPalabras=EticlausulaPalabras($_GET['palabra'],'v_aaa_texto.descriptor');
    $clausulaExcepto=EticlausulaExcepto($_GET['excepto']);
    $clausulaFrecuentes=EticlausulaFrecuentes($_GET['palabrasFrecuentes']);


    $sql2="SELECT v_aaa_texto.id as idtexto, v_aaa_texto.descriptor as descriptortexto FROM v_aaa_texto WHERE id_seguimiento_item = '$idseguimiento'  AND v_aaa_texto.id NOT IN (SELECT v_aaa_textovalor.id_texto_textovalor as idtexto FROM v_aaa_textovalor) $clausulaPalabras ";
    $reg['sqlX']=$sql2;
...
function EticlausulaPalabras($x,$campo){
    $palabra = isset($x) ? $x : '';
    $clausulaPalabras = '';
    ...
    if ($palabra) {
        ...
        $clausulaPalabras = " AND ( LOWER($campo) LIKE ";
        $clausulaPalabras .= implode(" OR LOWER($campo) LIKE ", $palabrasArray) . ") ";
    }
