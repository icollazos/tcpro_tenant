...
*/
   ...
   // regresar($result);
    $campos=$result['root']['alertas']['campos'];
...
//regresar(count($padres));
    ...
    $sql = "SELECT id, descriptor, fecha, fuente FROM v_aaa_texto $where AND id_esalerta_item=2  $whereFi $whereFf $wherePalabras $whereExcepto $wherePadres $clausulaSelects ORDER BY id DESC ";
