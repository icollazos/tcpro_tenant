...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($data->id)) {
        ...
        $sql = "DELETE FROM aaa_texto WHERE id = $id"; // Usamos un placeholder para evitar inyecciones SQL
        $sql = "UPDATE $tabla SET borrar = 1 WHERE id = $id"; // Usamos un placeholder para evitar inyecciones SQL
